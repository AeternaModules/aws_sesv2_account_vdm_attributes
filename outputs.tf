...
output "sesv2_account_vdm_attributes_dashboard_attributes" {
  ...
  value       = { for k, v in aws_sesv2_account_vdm_attributes.sesv2_account_vdm_attributes : k => v.dashboard_attributes if v.dashboard_attributes != null && length(v.dashboard_attributes) > 0 }
}
output "sesv2_account_vdm_attributes_guardian_attributes" {
  ...
  value       = { for k, v in aws_sesv2_account_vdm_attributes.sesv2_account_vdm_attributes : k => v.guardian_attributes if v.guardian_attributes != null && length(v.guardian_attributes) > 0 }
}
